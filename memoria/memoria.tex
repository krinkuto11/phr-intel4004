...
\addlinespace
M2 & \texttt{ext\_dir='1', load\_ir\_low} &
    La ROM vuelca el nibble bajo \texttt{"0001"} al bus.
    IR[3:0] $\leftarrow$ \texttt{"0001"}.
    El decodificador activa \texttt{inst\_group(8)} (grupo ADD) e
    \texttt{is\_2byte='0'}. \\
\addlinespace
X1 & \texttt{scratch\_oe, tmp\_load} &
