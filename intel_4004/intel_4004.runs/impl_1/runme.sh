...
HD_PWD='c:/Users/anderregidor/intel_4004/intel_4004.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_4004_soc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basys3_4004_soc.tcl -notrace
