...
REM
REM Generated by Vivado on Thu May 07 16:10:33 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_bus_interno_mux_vhdl.prj"
call xvhdl  --incr --relax -prj tb_bus_interno_mux_vhdl.prj -log xvhdl.log
